...
describe('POST /user/enrolled/drop', () => {
  const dropUrl = '/user/enrolled/drop';
  ...
  it('should return not found error if the user with the given user_id does not take the lesson with the given lesson_id', (done) => {
    request(app)
      .post(dropUrl)
      .send({
        user_id: user_ids[1],  
  ...
  it('should return the user with the given user_id with remaining enrolledLessons list and removed lesson with the given lesson_id', (done) => {
    ...
    request(app)
      .post(dropUrl)
      .send({ user_id: user_ids[0], lesson_id: lesson_ids[1] })
      .expect((res) => {
  ...
  it('should return the user with the given user_id with remaining enrolledLessons list and removed lesson with the given lesson_id', (done) => {
    ...
    request(app)
      .post(dropUrl)
      .send({ user_id: user_ids[1], lesson_id: lesson_ids[1] })
      .expect((res) => {
        expect(res.body.user).not.toBeNull();
        expect(res.body.user).not.toBeUndefined();
        expect(res.body.user.email).not.toBeNull();
