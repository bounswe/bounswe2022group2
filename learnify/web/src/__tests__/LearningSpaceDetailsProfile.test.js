...
test('learning space details profile ls component renders correctly', async () => {
...
test('learning space details icon image renders correctly', async () => {
    render(<BrowserRouter><LearningSpaceDetailsProfile /></BrowserRouter>);
    const profileImage = screen.getByAltText(/ls-icon-profile/i);
    expect(profileImage).toBeInTheDocument();
}  );

test('learning space details profile ls component title renders correctly', async () => {
    render(<BrowserRouter><LearningSpaceDetailsProfile /></BrowserRouter>);
    const learningSpaceDetailsProfile = screen.getByTestId(/learning-space-details-title/i);
    expect(learningSpaceDetailsProfile).toBeInTheDocument();
}   );
